...
<body>
  ...
  <div class="d-flex align-items-center justify-content-center vh-100">
    <div class="login-box text-center">
      ...
      <form method="POST" action="{{ route('manager.login.send') }}">
        @csrf

        <!-- Username -->
        <div class="input-group mb-3">
          <span class="input-group-text"><i class="fa fa-envelope"></i></span>
          <input type="text" name="email" id="email" class="form-control" placeholder="Username / IC Number" required>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <a href="{{ route('manager.register') }}" class="text-decoration-none">Register</a>
        </div>
