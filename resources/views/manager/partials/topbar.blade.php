                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <?php /*?><img src="../assets/images/sporteqalogo006xs-1-140x140.png" alt="Sporteqa v2.0" class="dark-logo" width="50"  />Sporteqa v2.1<?php */?>
                            <!-- Light Logo icon -->
                            <img src="../assets/images/sporteqalogo006xs-1-140x140.png" alt="Sporteqa v2.0" class="light-logo" width="50" /> <span class="light-logo">Sporteqa v2.0</span> 
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
                         <!-- dark Logo text -->
                         <img src="../assets/images/sporteqalogo006xs-1-140x140.png" alt="Sporteqa v2.0" class="dark-logo" width="50" />
                         <!-- Light Logo text -->    
                         <?php /*?><img src="../assets/images/sporteqalogo006xs-1-140x140.png" class="light-logo" alt="Sporteqa v2.0" width="80" /><?php */?></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
