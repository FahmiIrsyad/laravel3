...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('events/assets/fonts/simple-line-icons.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('events/assets/css/Simple-Slider.css') }}">
    <link rel="stylesheet" href="{{ asset('events/assets/css/smoothproducts.css') }}">
    <link rel="stylesheet" href="{{ asset('events/custom/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('events/custom/css/custom.css') }}">
    ...
    <link href="/events/plugins/animate/animate.css" rel="stylesheet">
    <link href="/events/plugins/qtip2/jquery.qtip.min.css" rel="stylesheet">
    ...
    <link href="/events/plugins/slick-1.8.1/slick/slick.css" rel="stylesheet">
    <link href="/events/plugins/slick-1.8.1/slick/slick-theme.css" rel="stylesheet">
    ...
    <script src="{{ asset('events/custom/js/jquery-3.3.1.min.js') }}"></script>
    <script src="{{ asset('events/custom/js/jquery-migrate-3.0.0.min.js') }}"></script>
   ...
   <script src="/events/plugins/noty/lib/noty.min.js"></script>
    ...
    <script src="{{ asset('events/plugins/slick-1.8.1/slick/slick.min.js') }}"></script>
