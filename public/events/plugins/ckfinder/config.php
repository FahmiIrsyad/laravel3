...
$config['licenseName'] = 'agriquip.net';
$config['licenseKey']  = '*L?N-*1**-U**9-*V**-*C**-7*Z*-2**K';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/events/userfiles/',
  	//'root'         => '../../userfiles/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
...
$config['resourceTypes'][] = array(
    'name'              => 'Images',
    'directory'         => 'user/'.$_SESSION['user_id'],
    'maxSize'           => 0,
