...
(function ($) {
	...
	$.fn.dataTableExt.oPagination.input = {
		'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
			...
			nFirst.innerHTML = '<button class="btn btn-secondary"><i class="fa fa-fast-backward"></i> '+language.sFirst+'</button>';
			nPrevious.innerHTML = '<button class="btn btn-secondary"><i class="fa fa-step-backward"></i> ' + language.sPrevious+'</button>';
			nNext.innerHTML = '<button class="btn btn-secondary">'+language.sNext + ' <i class="fa fa-step-forward"></i></button>';
			nLast.innerHTML = '<button class="btn btn-secondary">'+language.sLast + ' <i class="fa fa-fast-forward"></i></button>';
